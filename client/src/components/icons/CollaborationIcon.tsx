  ...
  return (
    ...
    >
      ...
      <g>
        ...
        <g>
          <circle cx="25" cy="30" r="10" fill="#FF9933" stroke="#000080" strokeWidth="3" />
          <path
        ...
        <g>
          <circle cx="50" cy="25" r="12" fill="#000080" stroke="#000080" strokeWidth="3" />
          <path
        ...
        <g>
          <circle cx="75" cy="30" r="10" fill="#138808" stroke="#000080" strokeWidth="3" />
          <path
        ...
        <circle cx="50" cy="10" r="6" fill="#FF9933" stroke="#000080" strokeWidth="2" />
      </g>
    </svg>
  );
};
