...
import { CircleIcon, X } from 'lucide-react';
                        ...
                        <>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                                ...
                                <div className="bg-white border-2 border-blue-900 rounded-xl p-5 hover:shadow-lg transition-shadow">
                                    <div className="flex items-start justify-between">
                                        <div>
                                            <p className="text-xs font-medium text-blue-900/60 uppercase tracking-wider">Rejected</p>
                                            <p className="text-2xl font-bold text-blue-900 mt-2">{analytics.rejectedCount}</p>
                                            <p className="text-xs text-blue-900/50 mt-2">Under review</p>
                                        </div>
                                        <div className="w-12 h-12 bg-gradient-to-br from-yellow-100 to-red-200 border-2 border-red-400 rounded-xl flex items-center justify-center">
                                            ...
                                            >
                                                ...
                                                {campaign.status?.toLowerCase() === 'rejected' && (
                                                    <div className="mb-4 bg-red-50 border-2 border-red-200 rounded-lg overflow-hidden">
                                                        <div className="p-3 border-b border-red-200 flex justify-between items-center">
                                                        ...
                                                        <div className="p-3">
                                                            {campaign.rejectionReason && (
                                                                <div className="mb-3">
                                                                    <p className="text-xs font-semibold text-red-900 mb-1 uppercase tracking-wide">Admin Note:</p>
                                                                    <p className="text-sm text-red-800 italic bg-white/50 p-2 rounded border border-red-100">
                                                                        "{campaign.rejectionReason}"
                                                                    </p>
                                                                </div>
                                                            )}
                                                            ...
                                                            <div className="flex gap-2">
                                                                ...
                                                                {(campaign.reapprovalCount || 0) < 3 && (
                                                                    <div className="text-[10px] text-red-600 flex items-center px-1">
                                                                        Fix issues & resubmit
                                                                    </div>
                                                                )}
                                                            </div>
