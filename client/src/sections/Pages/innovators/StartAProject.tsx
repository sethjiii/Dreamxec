...
const StartAProject = () => {
  const [howItWorksSwiper, setHowItWorksSwiper] = useState<any>(null);
  const [whatYouGetSwiper, setWhatYouGetSwiper] = useState<any>(null);
  const columns = [
    {
        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-12">
          ...
          <div className="relative">
            ...
            <Swiper
              ...
              slidesPerView={1}
              speed={800}
              onSwiper={(s) => setHowItWorksSwiper(s)}
        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
          ...
          <div className="relative">
            ...
            <Swiper
              ...
              slidesPerView={1}
              speed={800}
              onSwiper={(s) => setWhatYouGetSwiper(s)}
