...
const AboutUs = () => {
  ...
  return (
    <div className="min-h-screen bg-dreamxec-cream/80 pt-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">

        {/* HERO */}
        <div className="text-center  mb-16">
          <h1 className="text-4xl md:text-5xl font-bold text-dreamxec-navy font-display mb-6">
            Research Karega India <span className="text-dreamxec-orange">Toh Badhega India</span>
          </h1>
          <p className="text-lg md:text-xl text-dreamxec-navy/80 max-w-3xl mx-auto font-sans leading-relaxed">
            DreamXec is India’s student innovation crowdfunding platform. We fund ideas, connect mentors,
            and help students turn research and curiosity into real-world impact.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-20">
          <div className="bg-white p-8 rounded-xl shadow-pastel-card border-2 border-dreamxec-navy/10">
        ...
        <div className="max-w-5xl mx-auto mb-20 text-center">
          ...
          <p className="text-lg text-dreamxec-navy/70 font-sans leading-relaxed mt-4">
