  ...
  return (
    <div className="min-h-screen bg-dreamxec-cream relative overflow-hidden">
      <SEO
        ...
        description="Support the next generation of innovators. Browse and donate to verified student research and college projects."
        keywords="donate to student projects, support student innovation, fund student research, innovation funding India"
      />
      {/* Decorative stars */}
