      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-16">
            ...
            <div className="space-y-3 pt-4">
              ...
              <div className="flex flex-col sm:flex-row gap-2">
                <input
                  ...
                  className="flex-1 px-4 py-2 bg-dreamxec-cream/10 border border-dreamxec-orange/30 text-dreamxec-cream placeholder-dreamxec-cream/50 focus:outline-none focus:border-dreamxec-orange transition-colors"
                />
                <button className="px-6 py-2 bg-dreamxec-orange hover:bg-dreamxec-green text-white font-semibold transition-all duration-300 whitespace-nowrap">
                  Subscribe
                </button>
              </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 pt-8 items-center">
          ...
          <div className="flex items-center justify-center gap-6 order-1 lg:order-2">
            ...
            <a
              href="https://www.youtube.com/@dreamxec"
              className="text-dreamxec-cream hover:text-dreamxec-orange transition-colors duration-300"
              aria-label="YouTube"
              title="YouTube"
            >
